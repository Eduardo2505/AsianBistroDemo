...
class Pdf_ci extends CI_Controller 
{
    ...
    public function crearpdf()
    {
        ...
        $data = array(
            'inicial' => $inicial,
            'finalc' => $finalc,
            'provincias' => $this->pdf_model->getPedidos($inicial,$finalc,$sucursal,"Autorizado"),
            'provinciac' => $this->pdf_model->getPedidosCancelados($inicial,$finalc,$sucursal),
            'clientenuevo' => $this->pdf_model->getClientes($inicial,$finalc,$sucursal,0),
            'clientesFrecuentes' => $this->pdf_model->getClientes($inicial,$finalc,$sucursal,1),
            'productos' => $this->pdf_model->getProductos($inicial,$finalc,$sucursal),
            'productosc' => $this->pdf_model->getProductoscancelados($inicial,$finalc,$sucursal)
        );
        
        //hacemos que coja la vista como datos a imprimir
        //importante utf8_decode para mostrar bien las tildes, ñ y demás
        $this->html2pdf->html(utf8_decode($this->load->view('Pdf_ci/pdf', $data, true)));
