		...
		<a title="" href="http://asianbistro.mx/">INICIO</a>
				...
				<section id="contact" class="section-scroll main-section">
					...
					<div class="contact-content container section-padding">
						...
						<div class="col-xs-12 col-md-9"><h3>SU PEDIDO SE REALIZO EXITOSAMENTE</h3><br><h2>En seguida recibirá un correo de confirmación, nuestros operadores esta revisando su pedido, sino recibe el correo porfavor revise su <span style="color:red">bandeja de spam.<span></span></span></h2><h5 style="color:red">SU FOLIO ES:<?=$_GET["id"]?></h5><div class="product-btn"><a href="<?php echo site_url(); ?>" class="btn btn-color  ">ACEPTAR</a></div></div>
