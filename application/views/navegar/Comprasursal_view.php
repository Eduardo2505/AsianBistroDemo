				...
				<section id="contact" class="section-scroll main-section">
					...
					<div class="contact-content container section-padding" id="respuesta">
						...
						<div class="col-xs-12 col-md-9" >
							<h3>Formulario de Contácto TIPO DEPAGO : Recoger a sucursal <?php echo $nomss?></h3>

							
							<form id="guardar">
								<input type="hidden"  name="tipoPago" value="RecogerSucursal" required>

								       <input type="hidden"  name="colonia" id="colonia" value="-" required>
	                                    <input type="hidden"  name="delegacion" id="delegacion" value="-" required>
	                                    <input type="hidden"  name="idSucursal" id="idSucursal" value="<?php echo $idss?>" required>	                           
	                                    <input type="hidden" name="cambiTarjeta" id="cambiTarjeta" value="0">
	                                    <input    required type="hidden" placeholder="CALLE" name="calle" id="calle" value="-">
<input  maxlength="45" required type="hidden" placeholder="Número Exterior  ó N/A" name="numexte" id="numexte" value="0">
<input type="hidden" placeholder="Num Int." name="numint" id="numint" value="000">
<input type="hidden" placeholder="Entre que calles" name="calles" id="calles" value="-">
								<div class="col-md-6">
									...
									<table>
										...
										<td><input style="width:100%"  class="contact-form form-control" maxlength="5" onkeypress="return permite(event, 'num')" required type="hidden" placeholder="C.P." name="cp" id="cp" value="0000"></td></tr>
									</table>
								...
								<div class="col-md-6">
									<div class="form-group text-right button-submit btn-submit">
										<a href="<?php echo site_url('venta/Shopping') ?>" title="Regresar"  class="btn btn-dark button-send" >REGRESAR</a>
