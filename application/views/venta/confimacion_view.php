						...
						<nav id="main-navbar" class="hidden-xs hidden-sm">
							<div class="nav hidden-xs">
								...
								<div class="main-nav">
									<ul class="pull-right">
											...
											<a title="" href="<?php echo site_url() ?>">INICIO</a>
											</li>
										</ul>
									</div>
								</div>
							...
							<section id="blog" class="section-scroll main-section blog-content blog">
								<header class="section-header">
									<h2>GRACIAS POR COMPRAR CON NOSTROS</h2>
								</header>
							...
							<section id="contact" class="section-scroll main-section">
								...
								<div class="contact-content container section-padding">
									...
									<div class="col-xs-12 col-md-9">
										<h3>SU COMPRA FUE EXITOSAMENTE HECHA


										</h3><br>
										<h4>
											SU PAGO VA SER EN <?=strtoupper($TipoPAgo)?>
										</h4>
										<h1 style="color:red">
											SU FOLIO ES: <?=$folio?>
										</h1>
										<div class="product-btn">
											<a href="<?php echo site_url() ?>" class="btn btn-color  ">ACEPTAR</a>
										</div>
